...
public class DictionaryDaoImpl implements DictionaryDao {
    ...
    private static final String GET_STREET = "SELECT street_name, street_code " +
    ...
    @Override
    public List<RegisterOffice> findRegisterOffices(String officeId) throws DaoException {
